...
namespace Swm.Model
{
    ...
    public class Cell
    {
        ...
        /// Id
        /// </summary>
        public virtual Int32 CellId { get; protected set; }
...
#pragma warning restore IDE1006 // 命名样式
        ...
        void UpdateSD()
        {
            this.Shape = "SD_" + (this.Locations.Single(x => x.Deep == RackDeep.Deep1).Loaded() ? "1" : "0")
                + (this.Locations.Single(x => x.Deep == RackDeep.Deep2).Loaded() ? "1" : "0");
