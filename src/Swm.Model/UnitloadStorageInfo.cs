...
{
    /// <summary>
    /// 货载的存储信息。这些信息决定了入库分配货位的结果。
    /// </summary>
    public class UnitloadStorageInfo : IEquatable<UnitloadStorageInfo>
    {
        public UnitloadStorageInfo()
        {
            this.StorageGroup = Cst.NA;
            this.OutFlag = Cst.NA;
            this.ContainerSpecification = Cst.NA;
        }
        ...
        {
            return obj is UnitloadStorageInfo info &&
                   Weight == info.Weight &&
                   Height == info.Height &&
        ...
        public virtual bool Equals(UnitloadStorageInfo info)
        {
            return info != null &&
                   Weight == info.Weight &&
                   Height == info.Height &&
        ...
        public static bool operator ==(UnitloadStorageInfo left, UnitloadStorageInfo right)
        {
            return EqualityComparer<UnitloadStorageInfo>.Default.Equals(left, right);
        }
